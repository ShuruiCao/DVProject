...
.image {
  ...
  .image.visible {
    opacity: 0.2;
    visibility: visible;
    background-image: url('/src/img/mujerencampo.png');
    background-size: cover;
    background-repeat: no-repeat;
    background-position: center center;
...
.image1.visible1 {
    opacity: 0.2;
    visibility: visible;
    background-image: url('/src/img/housing_est.jpeg');
    background-size: cover;
    background-repeat: no-repeat;
    background-position: center center;
  }
...
.image2.visible2 {
    opacity: 0.2;
    visibility: visible;
    background-image: url('/src/img/housing_sm.jpeg');
    background-size: cover;
    background-repeat: no-repeat;
    background-position: center center;
  }
  ...
  .image.visible7 {
    opacity: 0.1;
    visibility: visible;
    background-image: url('/src/img/budgetspending.png');
    background-size: cover;
    background-repeat: no-repeat;
    background-position: center center;
  }
  ...
  .image.visible8 {
    opacity: 0.1;
    visibility: visible;
    background-image: url('/src/img/caravan.png');
    background-size: cover;
    background-repeat: no-repeat;
    background-position: center center;
  }
  ...
  .image.visible4 {
    opacity: 0.1;
    visibility: visible;
    background-image: url('/src/img/Housing.jpeg');
    background-size: cover;
    background-repeat: no-repeat;
    background-position: center center;
  }
  ...
  .image.visible5 {
    opacity: 0.1;
    visibility: visible;
    background-image: url('/src/img/Business.jpeg');
    background-size: cover;
    background-repeat: no-repeat;
    background-position: center center;
  }
